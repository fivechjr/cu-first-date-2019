            ...
            <View>
                ...
                <div className="text-gray-700">
                    <p className="font-headline text-lg leading-loose">
                        ...
                        และความทรงจำแรกพบให้กับน้อง ๆ Freshmen ที่พี่ ๆ เเต่ละคณะจัดขึ้นมา
                        โดยปีนี้งาน CU First Date ของเรามาในธีม
                    </p>
                    ...
                    <p className="font-headline text-lg leading-loose">
                        ...
                        เพื่อให้น้อง ๆ ได้เก็บเกี่ยวความรู้เเละประสบการณ์ชีวิตในรั้วจุฬาฯ
                        เเละออกไปเป็น ‘’ของขวัญ’’ ที่ดีแก่สังคมภายนอกต่อไป อันจะตรงกับคำกล่าวที่ว่า
                    </p>
                    ...
                    <p className="font-headline text-lg leading-loose">
                        นั่นเองซึ่งงาน CU First Date ของเรานั้นจะจัดแค่ปีละ 1 ครั้งเท่านั้น!
                        สำหรับน้อง ๆ เฟรชชี่เท่านั้นนะ ซึ่งภายในงานน้อง ๆ
                        จะได้พบกับความพิเศษมากมายที่พี่ ๆ ตั้งใจมอบให้ เช่น ได้เจอเพื่อน ๆ CU103
                        ทั้งในและนอกคณะ อีกทั้งยังมีกิจกรรมต่าง ๆ ที่พี่ ๆ
                        เตรียมพร้อมมาส่งต่อข้อมูลเกี่ยวกับคณะของน้อง ๆ
