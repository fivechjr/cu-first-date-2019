    ...
    <section className="bg-white py-20">
        <View>
            ...
            <p className="font-headline text-lg leading-loose">
                ...
                ๆ ได้ทำความรู้จักกับพี่ ๆ เเละเพื่อนๆในคณะ ผ่านการทำกิจกรรม เพื่อส่งมอบของขวัญ
                ความอบอุ่น ความประทับใจ และความทรงจำแรกพบให้กับน้อง ๆ Freshmen
                ที่พี่ๆเเต่ละคณะจัดขึ้นมา โดยปีนี้งาน CU First Date ของเรามาในธีม
            </p>
